...
Use this repo to submit defects, bugs, enhancement requests, and other issues related to any Learning Labs.

Learning Labs URL: https://developer.cisco.com/learning
...
1. Fill in the title.
    ...
    - To find the Lab-ID, look at the URL of the lab. The Lab-ID appears to the left of the step number. In the following example, the ID is shown in **bold**:
